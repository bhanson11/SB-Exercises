...
SELECT id, app_name FROM analytics WHERE id = 1880; --Web Browser for Android--
...
SELECT app_name, reviews, min_installs, SUM(min_installs)/SUM(reviews) AS proportion_of_min_installs_to_reviews FROM analytics GROUP BY app_name
, reviews, min_installs HAVING COUNT(min_installs) > 100000;